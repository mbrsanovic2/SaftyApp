...
class IngredientData {
    companion object {
        val ingredients = listOf(
            ...
            //IngredientEntity(name = "7-Up", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Absolut Citron", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Ale", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Angelica root", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Apple brandy", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Apple cider", color = Color.Yellow, isUnlocked = false),
            //IngredientEntity(name = "Applejack", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Apricot brandy", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Añejo rum", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Bitters", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Blackberry brandy", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Blended whiskey", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Cantaloupe", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Carbonated water", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Cherry brandy", color = Color(1), isUnlocked = false),
            ...
            //IngredientEntity(name = "Coffee brandy", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Creme de Cacao", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Dry Vermouth", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Dubonnet Rouge", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Espresso", iconFilePath = "https://www.thecocktaildb.com/images/ingredients/espresso-small.png", color = Color.Black,isUnlocked = false),
            //IngredientEntity(name = "Everclear", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Firewater", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Galliano", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Irish whiskey", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Johnnie Walker", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Lager", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Lemon vodka", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Light rum", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Midori melon liqueur", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Orange bitters", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Peach Vodka", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Peppermint schnapps", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Pisco", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Port", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Ricard", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Sambuca", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Sloe gin", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Southern Comfort", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Spiced rum", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Strawberry schnapps", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Sugar syrup", color = Color(1), isUnlocked = false),
            //IngredientEntity(name = "Sweet Vermouth", color = Color(1), isUnlocked = false),
        )
    }
}